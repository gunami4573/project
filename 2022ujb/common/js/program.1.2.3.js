...
function addWidget() {
    if (0 === $("body").find("#lWidget").length) {
        ...
        calIframeStr += '<iframe id="wWidget" name="wWidget" src="about:blank" title="달력"></iframe>', calIframeStr += "</div>", $("body").append(calIframeStr)
    }
}
...
function getCalendar(objName, syear, smonth, str) {
    if (!objName) return void alert("getCalendar(document.bbsNttForm.start_date)와 같이 입력 필드 정보를 추가 하세요.");
    addWidget();
    var id, name;
    null != str && void 0 != str && "undefined" != str || (str = "Widget"), id = "l" + str, name = "w" + str;
...
function GetIEVersion() {
    ...
    return Idx > 0 ? parseInt(sAgent.substring(Idx + 5, sAgent.indexOf(".", Idx))) : navigator.userAgent.match(/Trident\/7\./) ? 11 : 99
}
...
Dropdown.prototype.toggle = function (e) {
    ...
    if (dropdownClear(), options.position && !$parent.hasClass(options.position) && $parent.addClass(options.position), options.arrow && !$parent.hasClass("arrow") && $parent.addClass("arrow"), options.width) {
...
var objCal, activeClass = "obj-active";
9 === GetIEVersion() && $("body").addClass("ie9"), GetIEVersion() <= 8 && $("body").addClass("ie8"), $(function () {
    ...
    var showToggle = function (element, options) {
        $element = $(element), this.element = element, this.options = options, $element.on("click mouseenter", $.proxy(this.show, this)), $element.on("click.close mouseleave", $.proxy(this.hide, this))
    };
    ...
    function (jQuery) {
        ...
        for (createSvgWrapper = function (svg_tag_name) {
            var key, obj, val, _fn, _ref;
            obj = {
                _svgEl: null
            }, _ref = $("<svg><" + svg_tag_name + "/></svg>").find("" + svg_tag_name)[0], _fn = function (key) {
                return null != val && null != val.baseVal ? Object.defineProperty(obj, key, {
                    get: function () {
            ...
            for (key in _ref) val = _ref[key], _fn(key);
            return obj
        }, svg_tag_names = ["rect", "circle", "ellipse", "line", "polygon", "polyline"], wrap_map = {}, _i = 0, _len = svg_tag_names.length; _i < _len; _i++) tag_name = svg_tag_names[_i], wrap_map[tag_name] = createSvgWrapper(tag_name);
        svgWrapper = function (el) {
            return this._svgEl = el, this.__proto__ = wrap_map[el.tagName], this
        }, jQuery.fn.wrapSvg = function () {
            return this.map(function (i, el) {
                return "http://www.w3.org/2000/svg" !== el.namespaceURI || "_svgEl" in el ? el : new svgWrapper(el)
            })
        }
    }(window.jQuery),
    function (factory, jQuery, Zepto) {
        ...
        var Mask = function (el, mask, options) {
            var p = {
                ...
                setCaret: function (pos) {
                    try {
                        if (el.is(":focus")) {
                            ...
                            ctrl.setSelectionRange ? ctrl.setSelectionRange(pos, pos) : (range = ctrl.createTextRange(), range.collapse(!0), range.moveEnd("character", pos), range.moveStart("character", pos), range.select())
                        }
                    } catch (e) {
                        console.log('error')
                    }
                ...
                getMasked: function (skipMaskChars, val) {
                    var lastMaskChar, check, buf = [],
                        ...
                        maskDigitCount = 0,
                        maskDigitPosArr = [];
                    options.reverse ? (addMethod = "unshift", offset = -1, lastMaskChar = 0, m = maskLen - 1, v = valLen - 1, check = function () {
                        return m > -1 && v > -1
                    }) : (lastMaskChar = maskLen - 1, check = function () {
                        return m < maskLen && v < valLen
                    });
                    for (var lastUntranslatedMaskChar; check();) {
            ...
            mask = "function" == typeof mask ? mask(p.val(), void 0, el, options) : mask, jMask.mask = mask, jMask.options = options, jMask.remove = function () {
                ...
                if (onlyMask = onlyMask || !1, options = options || {}, jMask.clearIfNotMatch = $.jMaskGlobals.clearIfNotMatch, jMask.byPassKeys = $.jMaskGlobals.byPassKeys, jMask.translation = $.extend({}, $.jMaskGlobals.translation, options.translation), jMask = $.extend(!0, {}, jMask, options), regexMask = p.getRegexMask(), onlyMask) p.events(), p.val(p.getMasked());
                else {
        ...
        $.fn.mask = function (mask, options) {
            ...
            selector = selector || $.jMaskGlobals.maskElements, (selector instanceof $ ? selector : $(selector)).filter($.jMaskGlobals.dataMaskAttr).each(HTMLAttributes)
        };
        var globals = {
            ...
            useInput: !/Chrome\/[2-4][0-9]|SamsungBrowser/.test(window.navigator.userAgent) && function (eventName) {
    ...
    function (e, t, n) {
        ...
        function u(e, t, n) {
            var a;
            for (var r in e)
                if (e[r] in t) return !1 === n ? e[r] : (a = t[e[r]], o(a, "function") ? c(a, n || t) : a);
            return !1
        }
        ...
        function y(e, n, o, a) {
            var r, i, l, c, u = "modernizr",
                d = s("div"),
                p = f();
            if (parseInt(o, 10))
                for (; o--;) l = s("div"), l.id = a ? a[o] : u + (o + 1), d.appendChild(l);
        ...
        function m(t, o) {
            ...
            if ("CSS" in e && "supports" in e.CSS) {
                for (; a--;)
                    if (e.CSS.supports(d(t[a]), o)) return !0;
                return !1
            }
            if ("CSSSupportsRule" in e) {
                for (var r = []; a--;) r.push("(" + d(t[a]) + ":" + o + ")");
                return r = r.join(" or "), y("@supports (" + r + ") { #modernizr { position: absolute; } }", function (e) {
        ...
        function v(e, t, a, r) {
            ...
            for (var d, p, f, y, v, g = ["modernizr", "tspan", "samp"]; !z.style && g.length;) d = !0, z.modElem = s(g.shift()), z.style = z.modElem.style;
            for (f = e.length, p = 0; f > p; p++)
                if (y = e[p], v = z.style[y], i(y, "-") && (y = l(y)), z.style[y] !== n) {
        ...
        function g(e, t, n, a, r) {
            var s = e.charAt(0).toUpperCase() + e.slice(1),
                i = (e + " " + $.join(s + " ") + s).split(" ");
            return o(t, "string") || o(t, "undefined") ? v(i, t, a, r) : (i = (e + " " + k.join(s + " ") + s).split(" "), u(i, t, n))
        }
        ...
        Modernizr.inputtypes = function (e) {
            for (var o, a, r, s = e.length, l = 0; s > l; l++) P.setAttribute("type", o = e[l]), r = "text" !== P.type && "style" in P, r && (P.value = "1)", P.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(o) && P.style.WebkitAppearance !== n ? (b.appendChild(P), a = t.defaultView, r = a.getComputedStyle && "textfield" !== a.getComputedStyle(P, null).WebkitAppearance && 0 !== P.offsetHeight, b.removeChild(P)) : /^(search|tel)$/.test(o) || (r = /^(url|email)$/.test(o) ? P.checkValidity && !1 === P.checkValidity() : "1)" != P.value)), _[e[l]] = !!r;
            return _
        }(S);
        var E = "Moz O ms Webkit",
            $ = T._config.usePrefixes ? E.split(" ") : [];
        T._cssomPrefixes = $;
        ...
        Modernizr._q.unshift(function () {
            delete z.style
        }), T.testAllProps = g, T.testAllProps = h, Modernizr.addTest("cssgridlegacy", h("grid-columns", "10px", !0)), Modernizr.addTest("cssgrid", h("grid-template-rows", "none", !0)), Modernizr.addTest("flexbox", h("flexBasis", "1px", !0)),
            function () {
                var e, t, n, a, r, s, i;
                for (var l in C)
                    if (C.hasOwnProperty(l)) {
                        ...
                        for (a = o(t.fn, "function") ? t.fn() : t.fn, r = 0; r < e.length; r++) s = e[r], i = s.split("."), 1 === i.length ? Modernizr[i[0]] = a : (!Modernizr[i[0]] || Modernizr[i[0]] instanceof Boolean || (Modernizr[i[0]] = new Boolean(Modernizr[i[0]])), Modernizr[i[0]][i[1]] = a), w.push((a ? "" : "no-") + i.join("-"))
                    }
            }(),
            function (e) {
                var t = b.className,
    ...
    function (factory) {
        ...
        function alias(method, deprecationMsg) {
            return function () {
                return deprecationMsg !== undefined && $.fn.datepicker.deprecated(deprecationMsg), this[method].apply(this, arguments)
            }
        }
                ...
                var extras = {
                    ...
                    contains: function (d) {
                        for (var val = d && d.valueOf(), i = 0, l = this.length; i < l; i++)
                            if (0 <= this[i].valueOf() - val && this[i].valueOf() - val < 864e5) return i;
                        return -1
                    },
                    remove: function (i) {
                        this.splice(i, 1)
        ...
        Datepicker.prototype = {
            ...
            _process_options: function (opts) {
                ...
                var o = this.o = $.extend({}, this._o),
                    lang = o.language;
                dates[lang] || (lang = lang.split("-")[0], dates[lang] || (lang = defaults.language)), o.language = lang, o.startView = this._resolveViewName(o.startView), o.minViewMode = this._resolveViewName(o.minViewMode), o.maxViewMode = this._resolveViewName(o.maxViewMode), o.startView = Math.max(this.o.minViewMode, Math.min(this.o.maxViewMode, o.startView)), !0 !== o.multidate && (o.multidate = Number(o.multidate) || !1, !1 !== o.multidate && (o.multidate = Math.max(0, o.multidate))), o.multidateSeparator = String(o.multidateSeparator), o.weekStart %= 7, o.weekEnd = (o.weekStart + 6) % 7;
                var format = DPGlobal.parseFormat(o.format);
                o.startDate !== -1 / 0 && (o.startDate ? o.startDate instanceof Date ? o.startDate = this._local_to_utc(this._zero_time(o.startDate)) : o.startDate = DPGlobal.parseDate(o.startDate, format, o.language, o.assumeNearbyYear) : o.startDate = -1 / 0), o.endDate !== 1 / 0 && (o.endDate ? o.endDate instanceof Date ? o.endDate = this._local_to_utc(this._zero_time(o.endDate)) : o.endDate = DPGlobal.parseDate(o.endDate, format, o.language, o.assumeNearbyYear) : o.endDate = 1 / 0), o.daysOfWeekDisabled = this._resolveDaysOfWeek(o.daysOfWeekDisabled || []), o.daysOfWeekHighlighted = this._resolveDaysOfWeek(o.daysOfWeekHighlighted || []), o.datesDisabled = o.datesDisabled || [], $.isArray(o.datesDisabled) || (o.datesDisabled = o.datesDisabled.split(",")), o.datesDisabled = $.map(o.datesDisabled, function (d) {
                ...
                if (o.defaultViewDate instanceof Date || "string" == typeof o.defaultViewDate) o.defaultViewDate = DPGlobal.parseDate(o.defaultViewDate, format, o.language, o.assumeNearbyYear);
            ...
            show: function (e) {
                if (!(this.inputField.prop("disabled") || this.inputField.prop("readonly") && !1 === this.o.enableOnReadonly)) return this.isInline || this.picker.appendTo(this.o.container), this.place(), this.picker.show(), this._attachSecondaryEvents(), this._trigger("show"), (window.navigator.msMaxTouchPoints || "ontouchstart" in document) && this.o.disableTouchKeyboard && $(this.element).blur(), this.isInline || this.picker.find(".p-datepicker-" + DPGlobal.viewModes[this.viewMode].clsName + " .p-datepicker-switch").focus(), this
            },
            hide: function () {
                return this.isInline || !this.picker.is(":visible") ? this : (this.focusDate = null, this.picker.hide().detach(), this._detachSecondaryEvents(), this.setViewMode(this.o.startView), this.o.forceParse && this.inputField.val() && this.setValue(), this._trigger("hide"), this.picker.hide(), this)
            },
            destroy: function () {
            ...
            paste: function (e) {
                var dateString;
                if (e.originalEvent.clipboardData && e.originalEvent.clipboardData.types && -1 !== $.inArray("text/plain", e.originalEvent.clipboardData.types)) dateString = e.originalEvent.clipboardData.getData("text/plain");
                else {
            ...
            _utc_to_local: function (utc) {
                ...
                return local.getTimezoneOffset() !== utc.getTimezoneOffset() && (local = new Date(utc.getTime() + 6e4 * local.getTimezoneOffset())), local
            },
            ...
            place: function () {
                ...
                "body" !== this.o.container && (top += scrollTop), this.picker.removeClass("p-datepicker-orient-top p-datepicker-orient-bottom p-datepicker-orient-right p-datepicker-orient-left"), "auto" !== this.o.orientation.x ? (this.picker.addClass("p-datepicker-orient-" + this.o.orientation.x), "right" === this.o.orientation.x && (left -= calendarWidth - width)) : offset.left < 0 ? (this.picker.addClass("p-datepicker-orient-left"), left -= offset.left - 10) : left + calendarWidth > windowWidth ? (this.picker.addClass("p-datepicker-orient-right"), left += width - calendarWidth) : this.o.rtl ? this.picker.addClass("p-datepicker-orient-right") : this.picker.addClass("p-datepicker-orient-left");
                var top_overflow, yorient = this.o.orientation.y;
                if ("auto" === yorient && (top_overflow = -scrollTop + top - calendarHeight, yorient = top_overflow < 0 ? "bottom" : "top"), this.picker.addClass("p-datepicker-orient-" + yorient), "top" === yorient ? top -= calendarHeight + parseInt(this.picker.css("padding-top")) : top += height, this.o.rtl) {
            ...
            update: function () {
                ...
                }, this)), fromArgs = !0) : (dates = this.isInput ? this.element.val() : this.inputField.val() || this.element.data("date"), dates = dates && this.o.multidate ? dates.split(this.o.multidateSeparator) : [dates], delete this.element.data().date), dates = $.map(dates, $.proxy(function (date) {
                    return DPGlobal.parseDate(date, this.o.format, this.o.language, this.o.assumeNearbyYear)
                }, this)), dates = $.grep(dates, $.proxy(function (date) {
                    return !this.dateWithinRange(date) || !date
                }, this), !0), this.dates.replace(dates), this.o.updateViewDate && (this.dates.length ? this.viewDate = new Date(this.dates.get(-1)) : this.viewDate < this.o.startDate ? this.viewDate = new Date(this.o.startDate) : this.viewDate > this.o.endDate ? this.viewDate = new Date(this.o.endDate) : this.viewDate = this.o.defaultViewDate), fromArgs ? (this.setValue(), this.element.change()) : this.dates.length && String(oldDates) !== String(this.dates) && fromArgs && (this._trigger("changeDate"), this.element.change()), !this.dates.length && oldDates.length && (this._trigger("clearDate"), this.element.change()), this.fill(), this
            },
            fillDow: function () {
                if (this.o.showWeekDays) {
                    var dowCnt = this.o.weekStart,
                        html = "<tr>";
                    for (this.o.calendarWeeks && (html += '<th class="cw">&#160;</th>'); dowCnt < this.o.weekStart + 7;) html += '<th class="dow', -1 !== $.inArray(dowCnt, this.o.daysOfWeekDisabled) && (html += " disabled"), html += '">' + dates[this.o.language].daysMin[dowCnt++ % 7] + "</th>";
                    html += "</tr>", this.picker.find(".p-datepicker-days thead").append(html)
                }
            },
            fillMonths: function () {
                for (var focused, localDate = this._utc_to_local(this.viewDate), html = "", i = 0; i < 12; i++) focused = localDate && localDate.getMonth() === i ? " focused" : "", html += '<button  type="button" class="month' + focused + '">' + dates[this.o.language].monthsShort[i] + "</button>";
            ...
            getClassNames: function (date) {
                var cls = [],
                    ...
                    today = UTCToday();
                return date.getUTCFullYear() < year || date.getUTCFullYear() === year && date.getUTCMonth() < month ? cls.push("old") : (date.getUTCFullYear() > year || date.getUTCFullYear() === year && date.getUTCMonth() > month) && cls.push("new"), this.focusDate && date.valueOf() === this.focusDate.valueOf() && cls.push("focused"), this.o.todayHighlight && isUTCEquals(date, today) && cls.push("today"), -1 !== this.dates.contains(date) && cls.push("active"), this.dateWithinRange(date) || cls.push("disabled"), this.dateIsDisabled(date) && cls.push("disabled", "disabled-date"), -1 !== $.inArray(date.getUTCDay(), this.o.daysOfWeekHighlighted) && cls.push("highlighted"), this.range && (date > this.range[0] && date < this.range[this.range.length - 1] && cls.push("range"), -1 !== $.inArray(date.valueOf(), this.range) && cls.push("selected"), date.valueOf() === this.range[0] && cls.push("range-start"), date.valueOf() === this.range[this.range.length - 1] && cls.push("range-end")), cls
            },
            _fill_yearsView: function (selector, cssClass, factor, year, startYear, endYear, beforeFn) {
                ...
                }), currVal = startVal - step; currVal <= endVal + step; currVal += step) classes = [cssClass], tooltip = null, currVal === startVal - step ? classes.push("old") : currVal === endVal + step && classes.push("new"), -1 !== $.inArray(currVal, selected) && classes.push("active"), (currVal < startYear || currVal > endYear) && classes.push("disabled"), currVal === focusedVal && classes.push("focused"), beforeFn !== $.noop && (before = beforeFn(new Date(currVal, 0, 1)), before === undefined ? before = {} : "boolean" == typeof before ? before = {
                    enabled: before
                } : "string" == typeof before && (before = {
                    classes: before
                }), !1 === before.enabled && classes.push("disabled"), before.classes && (classes = classes.concat(before.classes.split(/\s+/))), before.tooltip && (tooltip = before.tooltip)), html += '<button type="button" class="' + classes.join(" ") + '"' + (tooltip ? ' title="' + tooltip + '"' : "") + ">" + currVal + "</button>";
                var titleText = "이동 없음";
                100 === step ? view.find(".p-datepicker-switch").text(startVal + dates[this.o.language].yearCentury + " - " + endVal + dates[this.o.language].yearCentury).attr("title", titleText) : 10 === step ? (this.o.maxViewMode > 3 && (titleText = "100년단위 연도 선택 이동"), view.find(".p-datepicker-switch").text(startVal + dates[this.o.language].yearCentury + " - " + endVal + dates[this.o.language].yearCentury).attr("title", titleText)) : (this.o.maxViewMode > 2 && (titleText = "10년단위 연도 선택 이동"), view.find(".p-datepicker-switch").text(startVal + dates[this.o.language].year + " - " + endVal + dates[this.o.language].year).attr("title", titleText)), view.find("td").html(html)
            },
            fill: function () {
                var tooltip, before, d = new Date(this.viewDate),
                ...
                if (!isNaN(year) && !isNaN(month)) {
                    this.picker.find(".p-datepicker-days .p-datepicker-switch").text(DPGlobal.formatDate(d, titleFormat, this.o.language)).attr("title", "월 선택 이동"), this.picker.find(".p-datepicker-footer  .today").text(todaytxt).css("display", !0 === this.o.todayBtn || "linked" === this.o.todayBtn ? "table-cell" : "none"), this.picker.find(".p-datepicker-footer .clear").text(cleartxt).css("display", !0 === this.o.clearBtn ? "table-cell" : "none"), this.picker.find(".p-datepicker-footer .close").text(closetxt).css("display", !0 === this.o.closeBtn ? "table-cell" : "none"), this.picker.find(".p-datepicker-title").text(this.o.title).css("display", "string" == typeof this.o.title && "" !== this.o.title ? "table-cell" : "none"), this.updateNavArrows(), this.fillMonths();
                    var prevMonth = UTCDate(year, month, 0),
                        day = prevMonth.getUTCDate();
                    prevMonth.setUTCDate(day - (prevMonth.getUTCDay() - this.o.weekStart + 7) % 7);
                    var nextMonth = new Date(prevMonth);
                    prevMonth.getUTCFullYear() < 100 && nextMonth.setUTCFullYear(prevMonth.getUTCFullYear()), nextMonth.setUTCDate(nextMonth.getUTCDate() + 42), nextMonth = nextMonth.valueOf();
                    for (var weekDay, clsName, html = []; prevMonth.valueOf() < nextMonth;) {
                        if ((weekDay = prevMonth.getUTCDay()) === this.o.weekStart && (html.push("<tr>"), this.o.calendarWeeks)) {
                        ...
                        clsName = this.getClassNames(prevMonth), clsName.push("day");
                        var content = prevMonth.getUTCDate();
                        this.o.beforeShowDay !== $.noop && (before = this.o.beforeShowDay(this._utc_to_local(prevMonth)), before === undefined ? before = {} : "boolean" == typeof before ? before = {
                            enabled: before
                        } : "string" == typeof before && (before = {
                            classes: before
                        }), !1 === before.enabled && clsName.push("disabled"), before.classes && (clsName = clsName.concat(before.classes.split(/\s+/))), before.tooltip && (tooltip = before.tooltip), before.content && (content = before.content)), clsName = $.isFunction($.uniqueSort) ? $.uniqueSort(clsName) : $.unique(clsName), html.push('<td><button type="button" class="' + clsName.join(" ") + '"' + (tooltip ? ' title="' + tooltip + '"' : "") + (clsName[0] == "active" ? ' title="선택됨"' : "") + (clsName[0] == "today" ? ' title="오늘"' : "") + ' data-date="' + prevMonth.getTime().toString() + '">' + content + "</button></td>"), tooltip = null, weekDay === this.o.weekEnd && html.push("</tr>"), prevMonth.setUTCDate(prevMonth.getUTCDate() + 1)
                    }
                    this.picker.find(".p-datepicker-days tbody").html(html.join(""));
                    var monthsTitle = dates[this.o.language].monthsTitle || dates.en.monthsTitle || "Months";
                    console.log(monthsTitle);
                    var months = this.picker.find(".p-datepicker-months").find(".p-datepicker-switch").text(this.o.maxViewMode < 2 ? monthsTitle + dates[this.o.language].year : year + dates[this.o.language].year).attr("title", "연도 선택 이동").end().find("tbody button").removeClass("active");
                    if ($.each(this.dates, function (i, d) {
                        d.getUTCFullYear() === year && months.eq(d.getUTCMonth()).addClass("active")
                    }), (year < startYear || year > endYear) && months.addClass("disabled"), year === startYear && months.slice(0, startMonth).addClass("disabled"), year === endYear && months.slice(endMonth + 1).addClass("disabled"), this.o.beforeShowMonth !== $.noop) {
                        var that = this;
                        $.each(months, function (i, month) {
                            ...
                            before === undefined ? before = {} : "boolean" == typeof before ? before = {
                                ...
                                classes: before
                            }), !1 !== before.enabled || $(month).hasClass("disabled") || $(month).addClass("disabled"), before.classes && $(month).addClass(before.classes), before.tooltip && $(month).prop("title", before.tooltip)
                        })
                    }
                    this._fill_yearsView(".p-datepicker-years", "year", 10, year, startYear, endYear, this.o.beforeShowYear), this._fill_yearsView(".p-datepicker-decades", "decade", 100, year, startYear, endYear, this.o.beforeShowDecade), this._fill_yearsView(".p-datepicker-centuries", "century", 1e3, year, startYear, endYear, this.o.beforeShowCentury), this.picker.find("button.disabled").attr("disabled", !0)
                }
            },
            updateNavArrows: function () {
                if (this._allow_update) {
                    var prevIsDisabled, nextIsDisabled, d = new Date(this.viewDate),
                        year = d.getUTCFullYear(),
                        month = d.getUTCMonth(),
                        startYear = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCFullYear() : -1 / 0,
                        startMonth = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCMonth() : -1 / 0,
                    ...
                    switch (this.viewMode) {
                        ...
                        case 1:
                            ...
                            break;
                        case 0:
                            prevIsDisabled = year <= startYear && month <= startMonth, nextIsDisabled = year >= endYear && month >= endMonth
                    }
            ...
            click: function (e) {
                ...
                target = $(e.target), target.hasClass("p-datepicker-switch") && this.viewMode !== this.o.maxViewMode && this.setViewMode(this.viewMode + 1), target.hasClass("today") && !target.hasClass("day") && (this.setViewMode(0), this._setDate(UTCToday(), "linked" === this.o.todayBtn ? null : "view")), target.hasClass("clear") && this.clearDates(), target.hasClass("close") && (this.hide(), this.isInput || this.element.focus()), target.hasClass("disabled") || (target.hasClass("month") || target.hasClass("year") || target.hasClass("decade") || target.hasClass("century")) && (this.viewDate.setUTCDate(1), day = 1, 1 === this.viewMode ? (month = target.parent().find("button").index(target), year = this.viewDate.getUTCFullYear(), this.viewDate.setUTCMonth(month)) : (month = 0, year = Number(target.text()), this.viewDate.setUTCFullYear(year)), this._trigger(DPGlobal.viewModes[this.viewMode - 1].e, this.viewDate), this.viewMode === this.o.minViewMode ? this._setDate(UTCDate(year, month, day)) : (this.setViewMode(this.viewMode - 1), this.fill())), this.picker.is(":visible") && this._focused_from && this._focused_from.focus(), delete this._focused_from
            },
            dayCellClick: function (e) {
                var $target = $(e.currentTarget),
                    timestamp = $target.data("date"),
                    date = new Date(timestamp);
                this.o.updateViewDate && (date.getUTCFullYear() !== this.viewDate.getUTCFullYear() && this._trigger("changeYear", this.viewDate), date.getUTCMonth() !== this.viewDate.getUTCMonth() && this._trigger("changeMonth", this.viewDate)), this._setDate(date), this.inputField.focus()
            },
            navArrowsClick: function (e) {
                var $target = $(e.currentTarget),
                    dir = $target.hasClass("prev") ? -1 : 1;
                0 !== this.viewMode && (dir *= 12 * DPGlobal.viewModes[this.viewMode].navStep), this.viewDate = this.moveMonth(this.viewDate, dir), this._trigger(DPGlobal.viewModes[this.viewMode].e, this.viewDate), this.fill()
            },
            _toggle_multidate: function (date) {
                var ix = this.dates.contains(date);
                if (date || this.dates.clear(), -1 !== ix ? (!0 === this.o.multidate || this.o.multidate > 1 || this.o.toggleActive) && this.dates.remove(ix) : !1 === this.o.multidate ? (this.dates.clear(), this.dates.push(date)) : this.dates.push(date), "number" == typeof this.o.multidate)
                    for (; this.dates.length > this.o.multidate;) this.dates.remove(0)
            },
            _setDate: function (date, which) {
                which && "date" !== which || this._toggle_multidate(date && new Date(date)), (!which && this.o.updateViewDate || "view" === which) && (this.viewDate = date && new Date(date)), this.fill(), this.setValue(), which && "view" === which || this._trigger("changeDate"), this.inputField.trigger("change"), !this.o.autoclose || which && "date" !== which || this.hide()
            },
            ...
            moveMonth: function (date, dir) {
                ...
                }, new_month = month + dir, new_date.setUTCMonth(new_month), new_month = (new_month + 12) % 12;
                else {
            ...
            setViewMode: function (viewMode) {
                this.viewMode = viewMode, this.picker.children("div").hide().filter(".p-datepicker-" + DPGlobal.viewModes[this.viewMode].clsName).show(), this.updateNavArrows(), this._trigger("changeViewMode", new Date(this.viewDate))
            }
        };
        var DateRangePicker = function (element, options) {
            $.data(element, "p-datepicker", this), this.element = $(element), this.inputs = $.map(options.inputs, function (i) {
                return i.jquery ? i[0] : i
            }), delete options.inputs, this.keepEmptyValues = options.keepEmptyValues, delete options.keepEmptyValues, datepickerPlugin.call($(this.inputs), options).on("changeDate", $.proxy(this.dateUpdated, this)), this.pickers = $.map(this.inputs, function (i) {
        ...
        var datepickerPlugin = ($.fn.datepicker, function (option) {
            ...
            if (this.each(function () {
                var $this = $(this),
                    ...
                    options = "object" == typeof option && option;
                if ($that = $this.closest(".p-date"), $this.parent().hasClass("p-datepicker__wrap") || $this.parents().hasClass("p-date__range") || $this.wrap("<div class='p-datepicker__wrap'></div>"), !data) {
                    ...
                    "body" === opts.container && (opts.container = $this.closest(opts.containerDefaultWrap)), $(this.group).hasClass("p-date__range") || opts.inputs ? ($.extend(opts, {
                        inputs: opts.inputs || $(this.group).find("input").toArray()
                    }), data = new DateRangePicker(this, opts)) : data = new Datepicker(this, opts), $this.data("datepicker", data)
                }
            ...
            if (this.length > 1) return console.log("단일 요소 수집에만 허용 (" + option + ")");
            ...
            DPGlobal = {
                ...
                parseDate: function (date, format, language, assumeNearby) {
                    ...
                    if (date in dateAliases && (date = dateAliases[date]), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/i.test(date)) {
                        for (parts = date.match(/([\-+]\d+)([dmwy])/gi), date = new Date, i = 0; i < parts.length; i++) part = parts[i].match(/([\-+]\d+)([dmwy])/i), dir = Number(part[1]), fn = fn_map[part[2].toLowerCase()], date = Datepicker.prototype[fn](date, dir);
                    ...
                    setters_map.yy = setters_map.yyyy, setters_map.M = setters_map.MM = setters_map.mm = setters_map.m, setters_map.dd = setters_map.d, date = UTCToday();
                ...
                formatDate: function (date, format, language) {
                    ...
                    for (var seps = $.extend([], format.separators), i = 0, cnt = format.parts.length; i <= cnt; i++) seps.length && date.push(seps.shift()), date.push(val[format.parts[i]]);
                    return date.join("")
                },
                ...
                headTemplate: '<caption>일자 선택용 달력 - 일,월,화,수,목,금,토</caption><thead><tr><th colspan="7" class="p-datepicker-title"></th></tr></thead>',
    ...
    var fileupload = function (btn, options) {
        $element = $(btn), this.element = btn, this.options = options, this.clearselector = ".clear", $region = $element.closest(this.options.parent), $originalinput = $region.find(this.options.original), $clearbtn = $region.find(this.clearselector), $clearbtn.on("click.cancle", $.proxy(this.clear, this)), $originalinput.on("change", $.proxy(this.change, this))
    };
    fileupload.prototype.change = function () {
        ...
        if (window.FileReader) {
            if (filename = this.filestrip($originalinput[0].files[0].name), $originalinput[0].files.length > 1) var filelength = $originalinput[0].files.length - 1
        } else filename = $originalinput.val().split("/").pop().split("\\").pop();
        filelength && (filename = filename + " 외 " + filelength), $clearbtn.addClass("active"), $showinput.html(filename)
    }, fileupload.prototype.filestrip = function (name) {
        var stripNumber;
        return $(window).width() < 640 && $(window).width() >= 420 ? stripNumber = 45 : $(window).width() < 419 && $(window).width() >= 400 ? stripNumber = 30 : $(window).width() < 400 && (stripNumber = 21), name.length > stripNumber ? name.substr(0, stripNumber / 3) + " ... " + name.substr(name.length - 8, name.length) : name
        ...
        var $element = this.element,
            ...
            $showinput = $region.find(this.options.showfilename),
            $clearbtn = $region.find(this.clearselector);
        $originalinput.replaceWith($originalinput.val("").clone(!0)), $showinput.empty(), $clearbtn.removeClass("active")
    ...
    function checkMapPlugin(option) {
        var $this = $(this),
            data = $this.data("map"),
            options = $.extend({}, CreateMap.DEFAULTS, $this.data(), "object" == typeof option && option);
    ...
    CreateMap.DEFAULTS = {
        ...
        if (map.setDraggable(this.options.draggable), map.setZoomable(this.options.zoomable), this.options.typecontrol) {
            var mapTypeControl = new daum.maps.MapTypeControl;
            map.addControl(mapTypeControl, daum.maps.ControlPosition.TOPRIGHT);
            var zoomControl = new daum.maps.ZoomControl;
            map.addControl(zoomControl, daum.maps.ControlPosition.RIGHT)
        }
        var imageSize = new daum.maps.Size(32, 42),
            imageOption = {
                offset: new daum.maps.Point(13, 42)
            },
            markerImage = new daum.maps.MarkerImage("/common/images/program/map_marker.png", imageSize, imageOption),
            markerPosition = new daum.maps.LatLng(this.options.lat, this.options.lng);
        if (new daum.maps.Marker({
            ...
            if (title.className = "p-map-info__title", title.appendChild(document.createTextNode(this.options.title)), content.appendChild(title), this.options.info) {
                var info = document.createElement("div");
                info.className = "p-map-info__content", info.appendChild(document.createTextNode(this.options.info)), content.appendChild(info), content.className = "p-map-info p-map-info--multi"
            }
    ...
    function modalPlugin(option) {
        return this.each(function () {
            var $this = $(this),
                ...
                href = $this.attr("href"),
                $target = $(option.target || href && href.replace(/.*(?=#[^\s]+$)/, "")),
                options = $.extend({}, Modal.DEFAULTS, $this.data(), $target.data(), "object" == typeof option && option),
                btn = option.parentbtn || this;
    ...
    function modalRemotePlugin(option) {
        var $this = $(this);
        if (!option.container) return void console.log("외부 파일을 넣을 컨텐이너가 없습니다.");
        $.ajax({
            type: "GET",
            url: option.remote,
            dataType: "text",
            ...
            success: function (data) {
                ...
                $btn = $(option.parentbtn), $container.html(data), $target.addClass("loaded"), $btn.trigger("loaded.modal"), modalPlugin.call($this, option)
            }
        })
    }
    var Modal = function (btn, options) {
        this.options = options, this.$body = $(document.body), this.$button = $(btn), this.href = this.$button.attr("href"), this.$element = $(this.options.target || this.href && this.href.replace(/.*(?=#[^\s]+$)/, "")), this.backdropselector = "modal__backdrop", this.widthtselector = "modal__body", this.heightselector = "modal__content", this.isShown = null
    };
    Modal.DEFAULTS = {
        backdrop: !0,
        show: !0,
        ...
        var that = this,
            ...
            e = $.Event("show.modal");
        if (this.$button.trigger(e), !this.isShown) {
            this.isShown = !0, this.$body.addClass("modal__open"), $("html").addClass("modal__open"), this.setSize(), element.show();
            element.hasClass("fade") && element[0].offsetWidth, element.addClass("active"), this.options.backdrop && this.backdrop(), element.on("click.close", "[data-close='modal']", $.proxy(this.hide, this)), $(document).off("focusin.modal").on("focusin.modal", function (e) {
    ...
    function openwindowPlugin(option) {
        var $this = $(this),
            data = $this.data("openwindow"),
            options = $.extend({}, OpenWindow.DEFAULTS, $this.data(), "object" == typeof option && option);
    ...
    OpenWindow.DEFAULTS = {
        ...
        this.element = $(element), this.options = options, this.options.url ? this.href = this.options.url : this.href = this.element.attr("href");
        var setWindow, windowLeft, windowTop;
        if (this.options.left) windowLeft = this.options.left;
        else {
            var popWidth = this.options.width,
                winWidth = window.innerWidth || document.body.clientWidth;
            windowLeft = (window.screenX || window.screenLeft || 0) + (winWidth - popWidth) / 2
        }
        if (this.options.top) windowTop = this.options.top;
        else {
            var popHeight = this.options.height,
                winHeight = window.innerHeight || document.body.clientHeight;
            windowTop = (window.screenY || window.screenTop || 0) + (winHeight - popHeight) / 2
        }
        setWindow = "menubar=no, ", setWindow += "location=no, ", setWindow += "resizable=" + this.options.resizable + ", ", setWindow += "scrollbars=" + this.options.scrollbars + ", ", setWindow += "status=" + this.options.status + ", ", setWindow += "width=" + this.options.width + ", ", setWindow += "height=" + this.options.height + ", ", setWindow += "left=" + windowLeft + ", ", setWindow += "top=" + windowTop, windowObjectReference = window.open(this.href, "", setWindow)
    ...
    var createProgress = function (el, options) {
        ...
        this.element = el, this.options = $.extend({}, setDefault, options), this.animated(this.element)
    };
    ...
    var createChartCircle = function (el, options) {
        ...
        this.element = el, this.firstChild = el.firstChild, this.options = $.extend({}, setDefault, options), this.createSvg(), this.createCircle(this.options.emptyclassName, this.options.emptyfill), this.createCircle(this.options.valueclassname, this.options.valuefill, this.options.percent - this.options.strokewidth)
    };
    createChartCircle.prototype.createSvg = function () {
        ...
        this.circle = document.createElementNS("http://www.w3.org/2000/svg", "circle"), setAttributes(this.circle, {
            class: classname,
    ...
    tab.prototype.show = function () {
        var $target, $targetGroup, $this = this.element,
            $ul = $this.closest("ul"),
            selector = $this.attr("href");
        selector = selector && selector.replace(/.*(?=#[^\s]*$)/, ""), $this.parent("li").hasClass("active") || ($target = $(selector), $targetGroup = $(selector).parent().closest("div"), this.activate($this.closest("li"), $ul, "> .active", "nav"), this.activate($target, $targetGroup, ".active"))
    }, tab.prototype.activate = function (element, container, cts, area) {
        var $active = container.find(cts);
        $active.hasClass("p-tab__body--slide") ? ($active.stop().hide().removeClass("active").end(), element.stop().slideDown(500, function () {
            $(this).addClass("active")
        })) : $active.hasClass("fade") ? ($active.stop().hide().removeClass("active").end(), element.stop().fadeIn(300, function () {
            $(this).addClass("active")
        })) : ($active.removeClass("active").end(), element.addClass("active")), "nav" === area && ($active.find("a, button").attr("title", ""), element.find("a, button").attr("title", "선택됨")), "nav" !== area && ($active.attr("title", "숨김"), element.attr("title", "열림"))
    }, $(document).on("click", "[data-button='tab']", function (e) {
        $(this).data("url") || (e.preventDefault(), $(this).each(function () {
            var $this, data, option;
            $this = $(this), data = $this.data("tab"), option = "show", data || $this.data("tab", data = new tab(this)), "string" == typeof option && data[option](), this.options = $this.data(), this.options.dropdown && Dropdown()
        }))
    })
}), $(function () {
    ...
    Accordion.prototype.show = function () {
        var $this = this.element,
            selector = $this.attr("href"),
            $target = $(selector);
        return this.options.arange ? void this.openToggle(this.options.arange) : $this.hasClass("active") ? (this.disabled($this), void this.disabled($target, "display")) : (this.activate($this), void this.activate($target, "display"))
        ...
        $(this.options.parent).find("[data-accordion]").each(function () {
            ...
            "open" === status ? ($(this).addClass("active"), $(active).addClass("active").show().attr("title", "열림")) : ($(this).removeClass("active"), $(active).removeClass("active").hide().attr("title", "숨김"))
        })
        ...
        e.preventDefault(), $(this).each(function () {
            var $this = $(this),
                ...
                options = $this.data();
            data || $this.data("accordion", data = new Accordion(this, "show", options)), data.show(), this.options = $this.data()
        })
    })
}), $(function () {
    ...
    var tableElement = function (table, options) {
        ...
        this.element = $(table), this.options = $.extend({}, setDefault, options), this.element.addClass(this.options.tabletype), this.$target = $(this.options.target).on("resize", $.proxy(this.tableCheck, this)), this.tableCheck()
    };
    tableElement.prototype.getState = function () {
        ...
        var addClassTarget, wrapElement = this.element,
            wrapClassName = classname;
        wrapClassName || (wrapClassName = this.options.addwrapclass), addClassTarget = wrapElement.closest("." + wrapClassName), addClassTarget[0] || wrapElement.wrap("<div class='" + wrapClassName + "' />")
        ...
        if (this.options.scrollguide) {
            ...
            scrollBottomPosition && scrollTopPosition ? hasClassName || (addClassTarget.removeClass("bounceout").addClass("bouncein " + this.options.scrollguide), bounceTime = setTimeout($.proxy(function () {
                this.bounceIcon()
        ...
        var trsChild, cells, trs = this.element.find("tr"),
            grid = {};
        trs.each(function (index, item) {
            grid[index] || (grid[index] = {}), trsChild = item.childNodes, cells = 0;
            for (var j = 0, cntJ = trsChild.length; j < cntJ; j++) grid[index][cells++] = trsChild[j];
    ...
    Tooltip.DEFAULTS = {
        ...
        self.hoverState = "in", "in" === self.hoverState && self.show()
    }, Tooltip.prototype.leave = function (obj) {
        var self = $(obj.currentTarget).data(this.type);
        self.hoverState = "out", "out" === self.hoverState && self.hide()
        ...
        var $tip = this.tip(),
            title = this.getTitle();
        $tip.find(".tooltip-inner").text(title), $tip.removeClass("fade in top bottom left right active"), this.options.maxwidth && $tip.find(".tooltip-inner").css({
            maxWidth: this.options.maxwidth
        })
    }, Tooltip.prototype.hide = function (callback) {
        var that = this,
            $tip = this.tip(),
            e = $.Event("hide." + this.type);
        if (this.$element.trigger(e), !e.isDefaultPrevented()) return $tip.removeClass("active"),
            function () {
                "in" !== that.hoverState && $tip.detach(), that.$element.removeAttr("aria-describedby").trigger("hidden." + that.type), callback && callback()
        ...
        var title;
        return title = this.$element.attr("data-original_title"), title || (title = this.options.original_title), title
    }, Tooltip.prototype.getUID = function (prefix) {
        do {
            prefix += ~~(1e6 * Math.secureRandom())
        ...
        var self = this;
        e && ((self = $(e.currentTarget).data(this.type)) || (self = new this.constructor(e.currentTarget), $(e.currentTarget).data(this.type, self))), self.tip().hasClass("active") ? self.leave(self) : self.enter(self)
    ...
    Popover.DEFAULTS = $.extend({}, $.fn.tooltip.Constructor.DEFAULTS, {
        ...
        $tip.find(".popover-title").text(title), $tip.find(".popover-content").children().detach().end().text(content), $tip.removeClass("fade top bottom left right in active"), $tip.find(".popover-title").html() || $tip.find(".popover-title").hide(), this.options.maxwidth && $tip.css({
            maxWidth: this.options.maxwidth
        })
        ...
        $('[data-button="popover"]').each(function () {
            ...
            var allPopover = $(this),
                data = allPopover.data();
            popoverPulgin.call(allPopover, data)
        })
    })
});

function getTimeCalendar(objName, syear, smonth, str) {
    if (!objName) return void alert("getTimeCalendar(document.bbsNttForm.start_date)와 같이 입력 필드 정보를 추가 하세요.");
    addWidget();
    var id, name;
    null != str && void 0 != str && "undefined" != str || (str = "Widget"), id = "l" + str, name = "w" + str;
    var win = document.getElementsByName(name)[0];
    with(objCal = objName, document.getElementById(id)) {
        ...
        var left = getAbsLeft(objName),
            top = getAbsTop(objName) + 30;
        win.width = "314", win.height = "325", win.style.width = "314px", win.style.height = "325px", $(document).ready(function () {
            if (460 > document.body.clientWidth) {
                var term = (document.body.clientWidth - win.width) / 2;
                left = term
            }
        }), style.left = left + "px", style.top = top + "px", null != syear && syear != undefined && "undefined" != syear || (syear = ""), null != smonth && smonth != undefined && "undefined" != smonth || (smonth = ""), self.eval(name).location.replace("/common/calendarTime.html?syear=" + syear + "&smonth=" + smonth), $(objName).addClass(activeClass)
    }
}