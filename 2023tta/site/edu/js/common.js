...
(function ($) {
    ...
    $(function () {
        ...
        $('.header_box .quick_link_box .quick_link_item .quick_link').on('mouseover', function(){
            var $this = $(this),
                $MyItem = $this.parent('.quick_link_item'),
                $OtherItem = $MyItem.siblings('.quick_link_item'),
                IsActive = $MyItem.is('.active'),
                MyLinkType = $MyItem.attr('data-link-type');
            if(!IsActive){
                $OtherItem.removeClass('active');
                $MyItem.addClass('active');
            }
            if(MyLinkType == 'edu'){
                $('.header_box .quick_link_box').removeClass('other');
                $('.header_box .quick_link_box').addClass('edu');
            }
            if(MyLinkType == 'other'){
                $('.header_box .quick_link_box').removeClass('edu');
                $('.header_box .quick_link_box').addClass('other');
            }
        });
        $('.header_box .quick_link_box .quick_link_item[data-link-type="other"] .quick_link').on('mouseout', function(){
            $('.header_box .quick_link_box').removeClass('other');
            $('.header_box .quick_link_box').addClass('edu');
            $('.header_box .quick_link_box .quick_link_item[data-link-type="other"]').removeClass('active');
