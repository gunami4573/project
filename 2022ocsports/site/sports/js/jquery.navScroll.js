                ...
                if (item !== undefined) {
                    if (scrollPos > (item.offset().top - changeBounds)) {
                        if (options.activeParent) {
                            ...
                            $(navItem[i]).parent().addClass(options.activeClassName).parents('.quickmenu').attr('class', 'quickmenu ' + options.activeClassName + i);
                            $('#wrapper').attr('data-section', 'oc_quick_menu_' + options.activeClassName + i);
                        } else {
